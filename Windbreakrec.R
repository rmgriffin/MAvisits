...
#          e = as.numeric(as.POSIXct("2022-07-31 23:59:59.999", tz = "America/New_York")) * 1000, fname = "July2022daylight") # July 2022
# batchapi(df, s = as.numeric(as.POSIXct("2023-07-01 00:00:00.000", tz = "America/New_York")) * 1000,
#          e = as.numeric(as.POSIXct("2023-07-31 23:59:59.999", tz = "America/New_York")) * 1000, fname = "July2023daylight") # July 2023
# batchapi(df, s = as.numeric(as.POSIXct("2024-07-01 00:00:00.000", tz = "America/New_York")) * 1000,
#          e = as.numeric(as.POSIXct("2024-07-31 23:59:59.999", tz = "America/New_York")) * 1000, fname = "July2024daylight") # July 2024
